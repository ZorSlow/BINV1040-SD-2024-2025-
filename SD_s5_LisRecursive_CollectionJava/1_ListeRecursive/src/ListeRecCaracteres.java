...
public class ListeRecCaracteres {
	...
	public char max(NoeudCaractere noeud) {
		if (noeud == null)
			return ' ';
		char maxRecherche = max(noeud.suivant);
		if(noeud.caractere > maxRecherche) {
	...
	public ArrayList<Character> enArrayList(){
		...
		ArrayList<Character> arrayCaracteres = new ArrayList<>();
		enArrayList(tete,arrayCaracteres);
        return arrayCaracteres;
    }private void  enArrayList(NoeudCaractere noeud, ArrayList<Character> arrayCaracteres){
		if (noeud == null)
			return ;
		arrayCaracteres.add(noeud.caractere);
		enArrayList(noeud.suivant,arrayCaracteres);
	...
	}public boolean estEgalA(NoeudCaractere noeud1, NoeudCaractere noeud2) {
