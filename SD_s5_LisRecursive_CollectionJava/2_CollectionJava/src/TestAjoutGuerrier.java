...
public class TestAjoutGuerrier {
	...
	public static void main(String[] args) {	
		...
		System.out.println("L'equipe avant ajout :"+equipe1.toString());
		System.out.println(equipe1.toString());
		
		System.out.println("L'equipe obtenue :"+equipe1.toString());
		...
		System.out.println("L'equipe avant ajout :"+equipe2);
		System.out.println(equipe2.toString());

		System.out.println("L'equipe obtenue :"+equipe2);
		...
		System.out.println("l'equipe attendue :"+equipeAttendue2);
		System.out.println(equipeAttendue2.toString()+equipeAttendue2);
		...
		System.out.println("L'equipe avant ajout :"+equipe3);
		System.out.println(equipe3.toString());

		System.out.println("L'equipe obtenue :"+equipe3);
		...
		System.out.println("l'equipe attendue :"+equipeAttendue3);
		...
		System.out.println("L'equipe avant ajout :"+equipe4);
		System.out.println(equipe4.toString());

		System.out.println("L'equipe obtenue :"+equipe4);
		...
		System.out.println("l'equipe attendue : "+equipeAttendue4);
		...
		System.out.println("L'equipe obtenue :"+equipe5);
		...
		System.out.println("l'equipe attendue :"+equipe5);
		...
		System.out.println("L'equipe avant ajout :"+equipe6);
		System.out.println(equipe6.toString());

		System.out.println("L'equipe obtenue :"+equipe6);
		...
		System.out.println("l'equipe attendue :"+equipeAttendue6);
